...
![ ](part2_1_1 new/plot_log_Y.png){#fig-2_1_1_logY}

![ ](part2_1_1 new/plot_Y.png){#fig-2_1_1_Y}

![ ](part2_1_1 new/plot_log_K.png){#fig-2_1_1_logK}

![ ](part2_1_1 new/plot_K.png){#fig-2_1_1_K}

![ ](part2_1_1 new/plot_little_k.png){#fig-2_1_1_little_k}

![ ](part2_1_1 new/plot_percent_delta_k.png){#fig-2_1_1_percent_delta_k}

![ ](part2_1_1 new/plot_MPK.png){#fig-2.1.1.MPK}

![ ](part2_1_1 new/plot_MPL.png){#fig-2.1.1.MPL}

![ ](part2_1_1 new/plot_log_A.png){#fig-2.1.1_logA}

![ ](parttwotwotwo/Y.png){#fig-outputlong}




![ ](parttwotwotwo/short/plot_log_A.png){#fig-logashort}

![ ](parttwotwotwo/log_A.png){#fig-logalong}
...
![ ](part2_1_2/calculations.png){#fig-2.1.2_calculations}



**part 2.1 figures**

![ ](parttwotwotwo/short/plot_MPK.png){#fig-2.2.1_MPK_short}

![ ](parttwotwotwo/short/plot_log_k.png){#fig-2.2.1_logA}

![ ](parttwotwotwo/K.png){#fig-2.2.1_k}

![ ](parttwotwotwo/y.png){#fig-2.2.1_Y}


**figures for part two 2.2**

![ ](parttwotwotwo/short/plot_K.png){#fig-capitalshort}

![ ](parttwotwotwo/K.png){#fig-capitallong}

![ ](parttwotwotwo/MPK.png){#fig-2.2.2_MPK}

![ ](parttwotwotwo/short/plot_little_k.png){#fig-littlekshort}

![ ](parttwotwotwo/little_k.png){#fig-littleklong}

![ ](parttwotwotwo/short/plot_Y.png){#fig-outputshort}
...
![Part 2.3.1 Y long](2_3_1_long/plot_log_Y.png){#fig-2.3.1_Ylong_log}

![Part 2.3.1 Y short](2_3_1_long/2_3_1_short/plot_Y.png){#fig-2.3.1_Yshort}

![Book: Figure 6.3](2_3_1_long/figure6_3_book_inc_L.png){#fig-2.3.1_L_increase}

::::
:::: {.column width="50%"}

![Book: Figure 6.4](2_3_1_long/figure6_4_book_inc_research.png){#fig-2.3.1_l_inc}

![Part 2.3.1 Y long](2_3_1_long/plot_MPK.png){#fig-2.3.1_MPKlong}
